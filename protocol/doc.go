...
// length-prefixed encrypted records (module path github.com/hdmain/tcpduplex/protocol).
//
...
// (nonce || ciphertext || tag) as produced by github.com/hdmain/tcpduplex/crypto.Session.
//
